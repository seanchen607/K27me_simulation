...
### TESTING NEW AVERAGE PLOTS  
  

  # total_me0_timer=total_me1_timer=total_me2_timer=total_me3_timer=0
  # 
  # for (p in 1:populationSize)
  # {
  #   total_me0_timer=total_me0_timer+population[[p]][["chr"]]$me0
  #   total_me1_timer=total_me1_timer+population[[p]][["chr"]]$me1
  #   total_me2_timer=total_me2_timer+population[[p]][["chr"]]$me2
  #   total_me3_timer=total_me3_timer+population[[p]][["chr"]]$me3
  # }
  
  if (prc2location%%100==0)
    {
    ### Average plots
    ...
    #   
       for (p in 1:populationSize)
       {
        summation0<-sum(population[[p]][["chr"]]$me0)
        summation1<-sum(population[[p]][["chr"]]$me1)
        summation2<-sum(population[[p]][["chr"]]$me2)
        summation3<-sum(population[[p]][["chr"]]$me3)
       }
      
    average0total<-c(average0total,(summation0/chromlength))
    average1total<-c(average1total,(summation1/chromlength))
    average2total<-c(average2total,(summation2/chromlength))
    average3total<-c(average3total,(summation3/chromlength))
    }
