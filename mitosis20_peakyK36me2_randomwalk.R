...
mitosis_prob=0.0001
depop=1
genic_structure=list(c(200:600),c(800:1000))
expression_structure=list(c(200:600))
k36me2_structure=list(c(200:600))
...
depositk36me2<-function(chrom,k36me2_structure)
{
  for (k in k36me2_structure)
  {
    ...
    for (q in start:end)
    {
      #chrom$K36me2[q]=probk36me2(start,end)[i]
      if (!is.na(probk36me2(start,end)[i]) && probk36me2(start,end)[i] > runif(n=1,min=0,max=1))
      {
        chrom$K36me2[q]=1
