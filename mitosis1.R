...
#  set.seed(cell)
  ...
  #print ("chromatin3")
  #print(chromatin$me3)
  if (rnorm(n=1,mean=0.5,sd=0.1) > 0.5)
  {
...
# par(mfrow=c(3,1))
# #plot(finalz$me0av,type = "h", ylim = c(0,1), main = paste("K27me0","  -- Average over : ",cell," Cells"," passage: ",passages,sep=""),ylab="")
# plot(finalz$me1av,type = "h", ylim = c(0,1), main = paste("K27me1","  -- Average over : ",cell," Cells"," passage: ",passages,sep=""),ylab="")
# plot(finalz$me2av,type = "h", ylim = c(0,1), main = paste("K27me2","  -- Average over : ",cell," Cells"," passage: ",passages,sep=""),ylab="")
# plot(finalz$me3av,type = "h", ylim = c(0,1), main = paste("K27me3","  -- Average over : ",cell," Cells"," passage: ",passages,sep=""),ylab="")
##dev.off()
