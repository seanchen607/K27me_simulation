...
homedir="~/Desktop/Desktop_June_2018/Histone_Mark_Simulation/Constant_prc2location/"
...
{
prc2location=0
while(prc2location <= chromlength)
{
  print (clock)
  #print(prc2location)
...
### ToDo: To take a snapshot every 1000 iteration of the clock base don the averages calculated below
...
### ToDo: To add the mitosis and finding the right probability
### ToDo: To implement stalling at the time of K27M
...
for (nucleosome in 1:chromlength)
{
  ...
  average<-c(average,summation/populationSize)
}
plot(average, ylim = c(0,1),type = "h")
