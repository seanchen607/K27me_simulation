...
for (cell in 1:initial_cell_count)  {
  ...
  #    mitosis=mitosis0-(round(runif(n=1,min=0,max=(mitosis0-10)),digits = 0))
  mitosis=mitosis0 
  print(mitosis)  
  ...
  if (runif(n=1,min = 0,max = 100) > 0)
  {
    ...
    if (cell ==1 && prc2==mitosis0){
      ...
      plot(daughter2$me0,type = "h", ylim = c(0,1), main = paste("Original Daughter Cell 2: K27me0","  -- PRC2 passage: ",prc2," Cell: ",cell,sep=""),ylab="")
      plot(daughter2$me1,type = "h", ylim = c(0,1), main = paste("Original Daughter Cell 2: K27me1","  -- PRC2 passage: ",prc2," Cell: ",cell,sep=""),ylab="")
      plot(daughter2$me2,type = "h", ylim = c(0,1), main = paste("Original Daughter Cell 2: K27me2","  -- PRC2 passage: ",prc2," Cell: ",cell,sep=""),ylab="")
      plot(daughter2$me3,type = "h", ylim = c(0,1), main = paste("Original Daughter Cell 2: K27me3","  -- PRC2 passage: ",prc2," Cell: ",cell,sep=""),ylab="")
...
for (state in (mitosis0-1):(mitosis0-1))
{
  #png(paste("~/Desktop/Histone_Mark_Simulation/Images/Average_State-",state,"-3marks-average.png",sep=""),width = 800,height = 600)
  par(mfrow=c(3,1))
