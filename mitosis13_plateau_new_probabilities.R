...
par(mfrow=c(2,2))
plot(me0avg,type = "l",ylim=c(0,1), main="Average H3K36me0",xlab = "Cycle")
plot(me1avg,type = "l",ylim=c(0,1), main="Average H3K36me1",xlab = "Cycle")
plot(me2avg,type = "l",ylim=c(0,1), main="Average H3K36me2",xlab = "Cycle")
plot(me3avg,type = "l",ylim=c(0,1), main="Average H3K36me3",xlab = "Cycle")
