...
## Primary chance for PRC2 attachment
prc2_chance<-runif(1,min = 0,max=1)


while (timer <= life)
{
print (paste(prc2location,timer,sep = "----"))
...
print (paste("PRC2 Location: ",prc2location," >>>>>> PRC2_CHANCE: ",prc2_chance," >>>>> THRESHOLD: ",prc2_threshold,sep = ""))
if(prc2_chance < prc2_threshold)
{
  prc2_attached=1  
}
else {
...
else if (prc2location > 0 && timer > 0) ### Start of the actual deposition 
  {
...
#### Snapshot ####
if (prc2location == chromlength || timer == life){
average0=c()
...
### ToDo: To take a snapshot every 1000 iteration of the timer base don the averages calculated below ### DONE (differently though)
